        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center my-2">
            ...
            <h2 className="mt-5 text-4xl font-black text-slate-900 md:text-5xl">
              Generate Unique AI-Powered Artwork
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-slate-600">
              Transform your imagination into stunning digital artwork using AI.
              Generate, store, mint, and verify ownership on the Cardano blockchain.
            </p>
          </div>
